// src/features/assessment_policy_school/api/usePublishSchoolAssessmentPolicyMutation.ts
...
export function usePublishSchoolAssessmentPolicyMutation(schoolId: string | undefined) {
  ...
  return useMutation({
    mutationFn: async (policyId: string) => {
      ...
      const response = await apiClient.patch<ApiResponse<string>>(
        `/v1/assessment-policies/schools/${schoolId}/${policyId}/publish`
      );
