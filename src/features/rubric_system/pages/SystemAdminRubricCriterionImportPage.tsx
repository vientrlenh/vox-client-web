...
export function SystemAdminRubricCriterionImportPage() {
    ...
    try {
      ...
      navigate(buildImportSessionDetailPath('/system-admin', preview.importSessionId), {
        state: {
          ...
          returnTo: `/system-admin/rubrics/${rubricId ?? ''}/versions/${versionId ?? ''}`,
  ...
  return (
    <section aria-labelledby="system-rubric-criterion-import-title" className="grid gap-6 text-slate-950">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1 className="mt-3 text-2xl font-black text-blue-950 sm:text-3xl" id="system-rubric-criterion-import-title">
