...
import { useSystemRubricCriterionBandQuery } from '../api/useSystemRubricCriterionBandQuery';
...
export function ViewRubricCriterionBandDialog({ isOpen, onClose, bandId }: Props) {
  const { data: band, isLoading } = useSystemRubricCriterionBandQuery(isOpen ? bandId : undefined);
