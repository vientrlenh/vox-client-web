...
export function SchoolAdminRubricCriterionImportPage() {
  ...
  return (
    <section aria-labelledby="school-rubric-criterion-import-title" className="grid gap-6 font-['Be_Vietnam_Pro',sans-serif] text-slate-950">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-slate-950" id="school-rubric-criterion-import-title">
