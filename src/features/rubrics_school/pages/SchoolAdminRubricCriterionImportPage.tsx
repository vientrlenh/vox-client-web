// src/features/rubrics/pages/SchoolAdminRubricCriterionImportPage.tsx
...
import { usePreviewSchoolRubricCriterionImportMutation } from '../api/usePreviewSchoolRubricCriterionImportMutation';
import { useAcceptSchoolRubricCriterionImportMutation } from '../api/useAcceptSchoolRubricCriterionImportMutation';
import { searchRubricCriteriaKeys } from '../api/useSearchSchoolRubricCriteriaQuery';
...
export function SchoolAdminRubricCriterionImportPage() {
  ...
  const previewMutation = usePreviewSchoolRubricCriterionImportMutation(schoolId, versionId);
  const acceptMutation = useAcceptSchoolRubricCriterionImportMutation(schoolId);
  ...
  async function handleAccept() {
    ...
    try {
      ...
      navigate(buildImportSessionDetailPath('/school-admin', preview.importSessionId), {
        state: {
          invalidateKeys: [searchRubricCriteriaKeys.all],
  ...
  return (
    <section aria-labelledby="school-rubric-criterion-import-title" className="grid gap-6 text-slate-950">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1 className="mt-3 text-2xl font-black text-blue-950 sm:text-3xl" id="school-rubric-criterion-import-title">
            Import Tiêu chí hàng loạt
          </h1>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
            Tải lên file CSV hoặc Excel, kiểm tra mapping cột và xác nhận import các tiêu chí mới.
          </p>
        </div>
        <Link
