// src/features/rubrics/pages/SchoolAdminRubricVersionImportPage.tsx
...
import { searchRubricVersionKeys } from '../api/useSearchSchoolRubricVersionsQuery';
...
export function SchoolAdminRubricVersionImportPage() {
  ...
  const previewMutation = usePreviewSchoolRubricVersionImportMutation(schoolId, rubricId);
  const acceptMutation = useAcceptSchoolRubricVersionImportMutation(schoolId);
