// src/features/rubrics/components/ViewRubricCriterionBandDialog.tsx

import { X, RefreshCw } from 'lucide-react';
import { useSchoolRubricCriterionBandQuery } from '../api/useSchoolRubricCriterionBandQuery';
...
export function ViewRubricCriterionBandDialog({ isOpen, onClose, schoolId, bandId }: Props) {
  const { data: band, isLoading } = useSchoolRubricCriterionBandQuery(isOpen ? schoolId : undefined, isOpen ? bandId : undefined);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative w-full max-w-md rounded-xl bg-white shadow-2xl">
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
          <h2 className="text-lg font-bold text-slate-900">Chi tiết Mức điểm</h2>
