...
import { useSchoolRubricResultBandQuery } from '../api/useSchoolRubricResultBandQuery';
...
export function ViewRubricResultBandDialog({ isOpen, onClose, schoolId, resultBandId }: Props) {
  const { data: band, isLoading } = useSchoolRubricResultBandQuery(isOpen ? schoolId : undefined, isOpen ? resultBandId : undefined);
