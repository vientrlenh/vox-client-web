...
type QuestionTopicPaginationProps = {
  isDisabled: boolean
...
export function QuestionTopicPagination({
  isDisabled,
  onPageChange,
  onPageSizeChange,
  page,
  ...
  return (
    <div className="flex flex-col gap-4 border-t border-slate-200 px-6 py-5 text-sm text-blue-950 md:flex-row md:items-center md:justify-between">
      <p>Tổng {totalElements} chủ đề</p>

      <div className="flex flex-wrap items-center gap-3">
        <select
          aria-label="Số chủ đề mỗi trang"
