// src/features/assessment_policy_system/pages/SystemAdminAssessmentPolicyImportPage.tsx
...
// schoolClass/schoolGrade/schoolGradeLevel chỉ áp dụng khi import có schoolId
// (School Admin) nên không đưa vào đây (System Admin bỏ qua phạm vi trường).
...
export function SystemAdminAssessmentPolicyImportPage() {
  const navigate = useNavigate();
  const queryClient = useQueryClient();

  const previewMutation = usePreviewSystemAssessmentPolicyImportMutation();
  const acceptMutation = useAcceptSystemAssessmentPolicyImportMutation();
