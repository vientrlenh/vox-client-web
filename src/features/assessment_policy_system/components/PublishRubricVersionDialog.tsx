// src/features/assessment_policy_system/components/PublishRubricVersionDialog.tsx
...
export function PublishRubricVersionDialog({
  ...
  const { mutateAsync: publishPolicies, isPending: isPublishingPolicies } =
    usePublishSystemAssessmentPoliciesByRubricVersionMutation();
  const { mutateAsync: publishVersion, isPending: isPublishingVersion } =
    usePublishSystemRubricVersionMutation();
  ...
  const handleConfirm = async () => {
    ...
    // Phải publish policy DRAFT trước, rồi mới tới Version: BE (ChangeSystemRubricVersionStatusUseCase)
