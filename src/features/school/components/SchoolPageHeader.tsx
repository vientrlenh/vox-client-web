...
export function SchoolPageHeader({
  isRefreshing,
  onRefresh,
}: SchoolPageHeaderProps) {
  return (
    <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
      <div>
        <h1
          className="text-2xl font-black text-blue-950 sm:text-3xl"
          id="system-admin-schools-title"
        >
          Quản lý trường học
        </h1>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
          Danh sách trường đã có tài khoản trên hệ thống. Xem thông tin chi tiết
          và khóa hoặc kích hoạt quyền truy cập của từng trường.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link
          ...
          to="/system-admin/schools/create"
        >
