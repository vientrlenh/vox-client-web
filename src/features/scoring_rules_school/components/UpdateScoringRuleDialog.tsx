// src/features/scoring_rules_school/components/UpdateScoringRuleDialog.tsx
...
import type { UpdateScoringRulePayload } from '../api/useUpdateSchoolScoringRuleMutation';
