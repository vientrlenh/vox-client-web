// src/features/scoring_rules_school/components/ScoringRulesPanel.tsx
...
import { useUpdateSchoolScoringRuleMutation } from '../api/useUpdateSchoolScoringRuleMutation';
import { useDeleteSchoolScoringRuleMutation } from '../api/useDeleteSchoolScoringRuleMutation';
...
export function ScoringRulesPanel({ schoolId, policyId }: Props) {
  ...
  const { data, isLoading, isError, refetch } = useSearchSchoolScoringRulesQuery(schoolId, policyId, filter, page, 10);
