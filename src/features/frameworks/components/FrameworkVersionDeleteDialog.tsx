...
type FrameworkVersionDeleteDialogProps = {
  errorMessage?: string
...
export function FrameworkVersionDeleteDialog({
  errorMessage,
  isSubmitting,
  onClose,
  onConfirm,
  version,
}: FrameworkVersionDeleteDialogProps) {
  if (!version) {
    return null
  }
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/45 px-4 py-6">
      <section
        aria-labelledby="framework-version-delete-title"
        aria-modal="true"
      ...
      >
        <div>
          <h2
            ...
            id="framework-version-delete-title"
          >
            Đưa phiên bản vào lưu trữ
          </h2>
          <p className="mt-2 text-sm font-medium leading-6 text-slate-600">
            ...
            sẽ bị đưa vào lưu trữ. Hành động này không thể hoàn tác.
          </p>
        </div>
        ...
        <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          ...
          >
            ...
            {isSubmitting ? 'Đang đưa vào lưu trữ...' : 'Đã đưa vào lưu trữ'}
          </button>
        </div>
      </section>
    </div>
