...
export function SubscriptionPlanCatalogPage() {
  ...
  return (
    // KHÔNG chốt max-width ở đây: các trang system admin đều tràn hết bề ngang (xem
    // SchoolSubscriptionsPage, SystemAdminUsersPage, SystemAdminRubricsPage...). Quy ước
    // `mx-auto max-w-*` chỉ dùng cho phía giáo viên/trường (exam, classTest, subscription_school),
    // đặt vào đây sẽ làm mỗi trang này hẹp hơn hẳn các trang cùng menu. Bề rộng cột đã được
    // xử lý trong PlanCatalogTable, không cần bó trang.
