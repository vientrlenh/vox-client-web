// src/features/scoring_rules_system/components/CreateScoringRuleDialog.tsx
...
import type { CreateScoringRulePayload } from '../api/useCreateSystemScoringRuleMutation';
