// src/features/scoring_rules_system/components/ViewScoringRuleDialog.tsx

import { X, RefreshCw } from 'lucide-react';
import { useSystemScoringRuleDetailQuery } from '../api/useSystemScoringRuleDetailQuery';
...
export function ViewScoringRuleDialog({ isOpen, onClose, policyId, ruleId }: Props) {
  const { data: rule, isLoading } = useSystemScoringRuleDetailQuery(
